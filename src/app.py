...
activities = {
    ...
    "Basketball Club": {
        "description": "Casual basketball practices and weekend scrimmages",
    ...
    "Drama Club": {
        "description": "Theater workshops and seasonal school productions",
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["amelia@mergington.edu", "sophia.r@mergington.edu"]
    }
}
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Validate participant exists before removal
